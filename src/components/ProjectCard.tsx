...
export default function ProjectCard({ project }: ProjectCardProps) {
    ...
    return (
        <Tilt className="rounded-lg">
            <div className={`${cardSurface} relative rounded-lg w-full h-full overflow-hidden`}>
                ...
                <div className="p-8 flex flex-col">
                    <h3 className="font-display font-bold text-heading text-[32px] leading-10 tracking-[-0.8px] mb-4">
                        {project.title}
                    </h3>
